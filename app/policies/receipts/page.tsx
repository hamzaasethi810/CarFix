  ...
  return (
    <div className="max-w-[68ch] mx-auto">
      <SheetHeader
        ...
        meta="Short version: we look at it once, then it is gone."
      />

      <SectionTitle>We delete it. Permanently.</SectionTitle>
      <Sheet className="p-5">
      ...
      <SectionTitle>A reviewer gets 120 seconds</SectionTitle>
      <Sheet className="p-5">
        <p className="text-body text-pretty">
      ...
      <SectionTitle>Only two things are checked</SectionTitle>
      <Sheet className="p-5">
        <p className="text-body text-pretty">
      ...
      <SectionTitle>What we keep</SectionTitle>
      <Sheet className="p-5">
      ...
      <SectionTitle>Why it works this way</SectionTitle>
      <Sheet className="p-5">
        <p className="text-body text-pretty">
      ...
      <SectionTitle>Business documents too</SectionTitle>
      <Sheet className="p-5">
        <p className="text-body text-pretty">
      ...
      <SectionTitle>You never have to upload one</SectionTitle>
      <Sheet className="p-5">
        <p className="text-body text-pretty">
