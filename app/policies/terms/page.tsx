...
export const metadata: Metadata = {
  title: "Terms and ground rules · CarFix",
  description:
    "What CarFix is, what it is not, and who is responsible for what people post.",
};
...
export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <SectionTitle>What CarFix is</SectionTitle>
      <Card className="space-y-3">
        <p className="text-subhead text-pretty">
          CarFix collects what car owners say they paid, at which shop, on which
